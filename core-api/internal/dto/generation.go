...
type CreateGenerationRequest struct {
	...
	Kind             generator.TaskType `json:"kind" enum:"generate_character_prototype,edit_character_prototype,edit_frames,generate_object_prototype,edit_object_prototype,generate_animation,derive_animation,edit_animation,generate_scenery,generate_tileset,add_tileset_item,edit_tileset_item,edit_tiles"`
