...
func prototypeReferenceImageRoles(
	...
	const creatingRole = `The Creating Reference is the user's reference for the object or subject being created and is always a strong reference. When the user creative brief asks to preserve, closely match, imitate, or make only specific changes to it, preserve every unmentioned visual attribute and make only the changes explicitly requested in the user creative brief.`
