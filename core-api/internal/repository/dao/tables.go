...
var defaultTagTemplates = []TagTemplate{
	{Name: "type:feature", Description: "Feature or user-facing capability", Color: "#2563EB"},
	{Name: "type:bug", Description: "Bug or defect", Color: "#DC2626"},
	{Name: "type:refactor", Description: "Internal refactor", Color: "#7C3AED"},
}
