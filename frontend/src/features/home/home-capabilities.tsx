...
export function HomeCapabilities() {
  ...
  return (
    <section aria-label={t("home.capabilitiesLabel")} className="bg-white">
      {capabilities.map(({ icon: Icon, preview, title, to }, index) => (
        <article
          key={title}
        ...
        >
          <div className="flex items-baseline justify-between border-b border-neutral-950/15 pb-5">
            <div className="text-4xl leading-none font-semibold tracking-[-0.045em] sm:text-5xl">
              {t(`home.capabilities.${capabilityKeys[index]}.title`)}
            </div>
              ...
              {title === "Scenery" ? (
                <div className="w-[92%]">
                  <div className="relative aspect-[16/10] overflow-hidden rounded-xl">
                    <img
                      src="/assets/sky.png"
                      alt={t("home.capabilities.scenery.alt")}
                    ...
                    <img
                      ...
                      alt={t("home.capabilities.scenery.treesAlt")}
                ...
                <img
                  src={preview.src}
                  alt={t(`home.capabilities.${capabilityKeys[index]}.alt`)}
