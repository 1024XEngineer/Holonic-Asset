      ...
      {!selectedStart ? (
        <div className="start-cards">
          ...
          <button
            type="button"
            className="start-card"
            onClick={() => setSelectedStart("blank")}
          >
            <span className="start-card-icon">
              <FilePlus2 size={20} />
            </span>
      ...
      <Dialog open={importOpen} onOpenChange={setImportOpen}>
        <DialogContent>
          ...
          <div className="grid grid-cols-2 gap-2 rounded-lg bg-muted p-1">
            <Button
              variant={importMode === "link" ? "default" : "ghost"}
          ...
          {importMode === "link" ? (
            ...
            <>
              <input
                ...
                onChange={(event) =>
                  setGameFile(event.target.files?.[0] ?? null)
                }
              />
              <button
                type="button"
              ...
              >
                <span>
                  ...
                  {gameFile?.name ?? "Choose a game build"}
                </span>
              </button>
            </>
          )}
          <DialogFooter>
            ...
            <Button
              disabled={importMode === "link" ? !gameUrl.trim() : !gameFile}
              onClick={() => {
                setImportOpen(false);
