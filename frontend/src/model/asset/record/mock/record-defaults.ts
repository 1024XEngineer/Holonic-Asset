        ...
        components: [
          {
            ...
            kind: "panel",
            bounds: { x: 6, y: 12, width: 25, height: 18 },
          },
          {
            id: "status-panel",
            label: "Status panel",
            kind: "panel",
            bounds: { x: 36, y: 12, width: 25, height: 18 },
          },
          {
            id: "search-input",
            label: "Search",
            kind: "input",
            bounds: { x: 68, y: 12, width: 24, height: 7 },
          },
          {
            id: "primary-action",
            label: "Confirm",
            kind: "button",
            bounds: { x: 6, y: 42, width: 19, height: 9 },
          },
          {
            id: "secondary-action",
            label: "Cancel",
            kind: "button",
            bounds: { x: 29, y: 42, width: 19, height: 9 },
          },
          {
            id: "gold-badge",
            label: "G 240",
            kind: "badge",
            bounds: { x: 68, y: 23, width: 11, height: 6 },
          },
          {
            id: "quick-icon",
            label: "Quick slot",
            kind: "icon",
            bounds: { x: 82, y: 23, width: 10, height: 6 },
          },
          {
            id: "health-bar",
            label: "Health",
            kind: "progress",
            bounds: { x: 53, y: 42, width: 18, height: 6 },
          },
          {
            id: "mana-bar",
            label: "Mana",
            kind: "progress",
            bounds: { x: 74, y: 42, width: 18, height: 6 },
          },
          {
            id: "volume-slider",
            label: "Volume",
            kind: "slider",
            bounds: { x: 6, y: 62, width: 28, height: 6 },
          },
          {
            id: "settings-icon",
            label: "Settings",
            kind: "icon",
            bounds: { x: 38, y: 62, width: 8, height: 6 },
          },
        ],
      },
    } as AssetRecordForKind<K>;
